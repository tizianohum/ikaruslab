...
CPP_SRCS += \
../firmware/Control/Control.cpp 

OBJS += \
./firmware/Control/Control.o 

CPP_DEPS += \
./firmware/Control/Control.d 


# Each subdirectory must supply rules for building sources it contributes
firmware/Control/%.o firmware/Control/%.su firmware/Control/%.cyclo: ../firmware/Control/%.cpp firmware/Control/subdir.mk
...
clean-firmware-2f-Control:
	-$(RM) ./firmware/Control/Control.cyclo ./firmware/Control/Control.d ./firmware/Control/Control.o ./firmware/Control/Control.su
