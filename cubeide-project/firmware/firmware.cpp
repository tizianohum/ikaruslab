...
static const osThreadAttr_t firmwareTask_attributes = { .name = "FirmwareHelper",
		.stack_size = 1200 * 4,   // Achtung: CMSIS will BYTES, nicht Words!
		.priority = (osPriority_t) osPriorityNormal2, };


static const osThreadAttr_t control_task_attributes = { .name = "control",
		.stack_size = 2560 * 4, .priority = (osPriority_t) osPriorityAboveNormal, };
...
HAL_StatusTypeDef IKARUS_Firmware::init() {
	...
	motor_controller_config_t motorontrollerConfig = {
			.htim1 = &htim1,.channel_1 = TIM_CHANNEL_1,
			.htim2 = &htim1, .channel_2 = TIM_CHANNEL_4,
			.htim3 = &htim15, .channel_3 = TIM_CHANNEL_1,
	...
	ultrasonic_config_t ultrasonicConfig = { .frequence_tim = &htim17,
			...
			echo_Pin };
	mpu6050_config_t imuConfig = { .address = MPU6050_ADDR, .hi2c =
			&hi2c2, .acc_range = MPU6050_ACC_RANGE_8G, .gyr_range =
