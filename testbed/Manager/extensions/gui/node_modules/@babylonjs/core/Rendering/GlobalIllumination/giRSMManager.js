...
export class GIRSMManager {
    ...
    _createPostProcesses() {
        ...
        const geometryBufferRenderer = this._scene.enableGeometryBufferRenderer(this._enableBlur ? this._outputDimensions : this._giTextureDimensions, 15, GIRSMManager.GeometryBufferTextureTypesAndFormats);
